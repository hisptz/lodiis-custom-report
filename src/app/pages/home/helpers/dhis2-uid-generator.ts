...
export function uuid(){
    const letters:string = 'abcdefghijklmnopqrstuvwxyz' + 'ABCDEFGHIJKLMNOPQRSTUVWXYZ';
    ...
    for (let codeSIZEPosition:number = 1;codeSIZEPosition < CODESIZE;codeSIZEPosition++)
    {
